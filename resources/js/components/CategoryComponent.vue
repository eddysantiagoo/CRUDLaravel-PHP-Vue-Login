<template>
            ...
            <div class="card">
                <div class="card-header bg-dark">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <button @click="createTask" class="btn btn-success btn-sm float-end">Nueva categoria</button>
                        </div>
                    </div>
                </div>
    ...
    <div :class="`modal-dialog modal-dialog-centered ${!deleteMode ? 'modal-lg' : 'modal-sm'}`">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="taskModalLabel" v-show="!deleteMode">{{!editMode ? 'Create new category 🐢' : 'Update Task'}}</h5>
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="task_file">Category photo</label>
        ...
        <div class="modal-footer" v-show="!deleteMode">
            ...
            <button type="button" @click="!editMode ? storeTask() : updateTask()" class="btn btn-primary">{{!editMode ? 'Create category!' : 'Save Changes'}}</button>
        </div>
        <div class="modal-footer" v-show="deleteMode">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>

<template>
            ...
            <div class="card">
                <div class="card-header bg-dark">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <button @click="createTask" class="btn btn-success btn-sm float-end">Nueva POST</button>
                        </div>
                    </div>
                </div>
    ...
    <div :class="`modal-dialog modal-dialog-centered ${!deleteMode ? 'modal-lg' : 'modal-sm'}`">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="taskModalLabel" v-show="!deleteMode">{{!editMode ? 'Create new post 🐢' : 'Update Task'}}</h5>
        ...
        <div class="modal-body">
            ...
            <h5 class="text-center" v-show="deleteMode">Are you sure you want to delete this post?</h5>
        </div>
        <div class="modal-footer" v-show="!deleteMode">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            <button type="button" @click="!editMode ? storeTask() : updateTask()" class="btn btn-primary">{{!editMode ? 'Create post!' : 'Save Changes'}}</button>
        </div>
        <div class="modal-footer" v-show="deleteMode">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
